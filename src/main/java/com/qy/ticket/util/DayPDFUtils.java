...
public class DayPDFUtils {
  ...
  public static void setPdfTableTitle(
      PdfPTable table, Font font, String[] detailsTableHeader, String boldTitle) throws Exception {
  ...
  private static void setPdfTableBody(
      ...
      for (int i = 0; i < detailsTableHeader.length; i++) {
        ...
        switch (i) {
          ...
          case 2:
            ...
            break;
          case 3:
            value = tblRecord.getAmount() + "";
            break;
          case 4:
            value = tblRecord.getRefundAmount() + "";
            break;
          case 5:
            value = tblRecord.getIncome() + "";
            break;
          case 6:
    ...
    for (int i = 0; i < detailsTableHeader.length; i++) {
      if (i == 4) {
        ...
        PdfPCell cell = new PdfPCell();
        Paragraph para = new Paragraph(sumRecordDTO.getIncome().add(sumRecordDTO.getWxFee()) + "", font);
        cell.setPhrase(para);
        cell.setBorderWidthRight(2);
        cell.setBorderWidthTop(2);
        cell.setBorderWidthBottom(2);
  ...
  public static void setSumTableBody(
      PdfPTable table, Font font, SumRecordDTO sumRecordDTO, String time) throws Exception {
    for (int i = 0; i < sumTableHeader.length; i++) {
      String value = "";
      switch (i) {
        case 0:
        ...
        case 1:
          ...
          break;
        case 2:
          value = sumRecordDTO.getIncome().add(sumRecordDTO.getWxFee()) + "";
          break;
        case 3:
          value = sumRecordDTO.getWxFee() + "";
          break;
        case 4:
