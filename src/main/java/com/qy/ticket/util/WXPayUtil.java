...
public class WXPayUtil {
    ...
    public static Map<String, String> objectToMap(Object o) throws IllegalAccessException {
        ...
        for (Field field : declaredFields) {
            ...
            if (o2 != null && StringUtils.isNotBlank(o2.toString().trim())) {
                // 保留字处理
                if ("wxPackage".equals(field.getName())) {
                    map.put("package", o2.toString().trim());
                }else{
                    map.put(field.getName(), o2.toString().trim());
                }
     ...
     */
    public static Object mapToObject(Map<String, String> map, Class<?> aClass) throws IllegalAccessException, InstantiationException {
