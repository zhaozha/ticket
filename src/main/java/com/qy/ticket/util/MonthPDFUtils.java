...
public class MonthPDFUtils {
    ...
    public static void export(String name, String time, HttpServletResponse response, List<TblRecordDTO> tblRecordDTOS, Integer proportion, SumRecordDTO sumRecordDTO, String productName) throws Exception {
        String FONT =
    ...
    public static void setSumTableBody(PdfPTable table, Font font, SumRecordDTO sumRecordDTO, String time, String[] sumTableHeader, Integer proportion) throws Exception {
    ...
    // 填充汇总表头
    public static void setSumTableTitle(PdfPTable table, Font font, String[] sumTableHeader) throws Exception {
        for (int i = 0; i < sumTableHeader.length; i++) {
            PdfPCell cell = new PdfPCell();
            cell.setFixedHeight(18);
    ...
    private static void setPdfTableBody(PdfPTable table, Font font, List<TblRecordDTO> tblRecordDTOS, String[] detailsTableHeader) throws Exception {
            ...
            for (int i = 0; i < detailsTableHeader.length; i++) {
                ...
                switch (i) {
                    case 0:
                        ...
                        break;
                    case 1:
                        value = NumberUtil.divide100(new BigDecimal(tblRecordDTO.getAmount()));
                        break;
                    case 2:
                        value = NumberUtil.divide100(new BigDecimal(tblRecordDTO.getRefundAmount()));
                        break;
                    case 3:
                        value = NumberUtil.divide100(new BigDecimal(tblRecordDTO.getIncome() + tblRecordDTO.getWxFee()));
                        break;
                    case 4:
